...
var AccordionButton = React4.forwardRef(({
  as: Component = "button",
  bsPrefix,
  className,
  onClick,
  ...
  return (0, import_jsx_runtime2.jsx)(Component, {
    ...
    className: (0, import_classnames2.default)(className, bsPrefix, !isAccordionItemSelected(activeEventKey, eventKey) && "collapsed")
  });
});
...
//# sourceMappingURL=chunk-6LS7IFY4.js.map
