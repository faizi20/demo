...
var FormSelect = React7.forwardRef(({
  bsPrefix,
  size,
  htmlSize,
  className,
...
var FormText = React8.forwardRef(
  ({
    bsPrefix,
    className,
    as: Component = "small",
...
var FloatingLabel = React9.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
  ...
  return (0, import_jsx_runtime12.jsxs)(FormGroup_default, {
    ref,
    className: (0, import_classnames8.default)(className, bsPrefix),
    controlId,
    ...props,
    children: [children, (0, import_jsx_runtime11.jsx)("label", {
      htmlFor: controlId,
      children: label
    })]
  });
...
var Switch = React11.forwardRef((props, ref) => (0, import_jsx_runtime14.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
//# sourceMappingURL=chunk-HR7BHHE2.js.map
