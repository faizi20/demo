import {
  ...
  Modal_default,
  getSharedManager
} from "./chunk-XTFHK7IN.js";
import {
  Fade_default
} from "./chunk-W4YSGXQQ.js";
import {
  NavbarContext_default
} from "./chunk-64RWIKZB.js";
import {
  SelectableContext_default
} from "./chunk-3IC4AO2I.js";
import {
  useIsomorphicEffect_default
} from "./chunk-LW3YUT2C.js";
import {
  useEventCallback
} from "./chunk-M6T2AL3Z.js";
import {
  Collapse_default
} from "./chunk-PVMYBSJQ.js";
import {
  ENTERED,
  ENTERING,
  EXITING,
...
} from "./chunk-3OGBNRTQ.js";
import {
  useUncontrolled
} from "./chunk-IYJEL3WX.js";
import {
  divWithClassName_default
} from "./chunk-Z6LWXP5F.js";
import {
  createWithBsPrefix
} from "./chunk-QWV5WNB5.js";
import {
  require_classnames,
  useBootstrapPrefix
} from "./chunk-MIGQSLIG.js";
import {
  require_jsx_runtime
} from "./chunk-5E2EQGHM.js";
import {
  require_react
...
var OffcanvasToggling = React3.forwardRef(({
  bsPrefix,
  className,
  children,
  ...props
...
function DialogTransition(props) {
  return (0, import_jsx_runtime4.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
function BackdropTransition(props) {
  return (0, import_jsx_runtime4.jsx)(Fade_default, {
    ...props
  });
}
var Offcanvas = React4.forwardRef(({
  ...
  const renderBackdrop = (0, import_react3.useCallback)((backdropProps) => (0, import_jsx_runtime4.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames4.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime4.jsx)("div", {
    ...dialogProps,
    ...props,
    className: (0, import_classnames4.default)(className, responsive ? `${bsPrefix}-${responsive}` : bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
  return (0, import_jsx_runtime6.jsxs)(import_jsx_runtime5.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime4.jsx)(ModalContext_default.Provider, {
      value: modalContext,
      children: (0, import_jsx_runtime4.jsx)(Modal_default, {
        show: showOffcanvas,
        ref,
        backdrop,
        container,
...
var NavbarCollapse = React5.forwardRef(({
  ...
  return (0, import_jsx_runtime7.jsx)(Collapse_default, {
...
var NavbarToggle = React6.forwardRef(({
  ...
  return (0, import_jsx_runtime8.jsx)(Component, {
    ...
    onClick: handleClick,
    "aria-label": label,
    className: (0, import_classnames5.default)(className, bsPrefix, !expanded && "collapsed"),
    children: children || (0, import_jsx_runtime8.jsx)("span", {
      className: `${bsPrefix}-icon`
    })
  });
});
NavbarToggle.displayName = "NavbarToggle";
NavbarToggle.defaultProps = defaultProps4;
...
var NavbarOffcanvas = React7.forwardRef((props, ref) => {
  const context = (0, import_react6.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime9.jsx)(Offcanvas_default, {
    ref,
...
var Navbar = React8.forwardRef((props, ref) => {
  const {
  ...
  return (0, import_jsx_runtime10.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
    children: (0, import_jsx_runtime10.jsx)(SelectableContext_default.Provider, {
      value: handleCollapse,
      children: (0, import_jsx_runtime10.jsx)(Component, {
        ref,
        ...controlledProps,
        className: (0, import_classnames6.default)(className, bsPrefix, expand && expandClass, variant && `${bsPrefix}-${variant}`, bg && `bg-${bg}`, sticky && `sticky-${sticky}`, fixed && `fixed-${fixed}`)
      })
    })
  });
});
Navbar.defaultProps = defaultProps5;
...
//# sourceMappingURL=chunk-2NGRYFJP.js.map
