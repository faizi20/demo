...
import BadgeOne from "../../../../assets/img/card_badge2.png";
import BadgeTwo from "../../../../assets/img/classespurple.png";
import BadgeThree from "../../../../assets/img/card_badge1.png";
  ...
  return (
    <div className="cards_main game_cards">
      <Row className="even_odd_border">
        {gaming.map((game) => (
          <RentCard key={game.id} game={game} />
        ))}
      </Row>
    </div>
  );
