...
import MyVerticallyCenteredModals from '../../Components/Modals/BuyAssetsModal/BuyAssetsModal';
...
const MarketPlaceSingle = props => {
  ...
  const [rentAssets, setRentAssets] = useState(false);
